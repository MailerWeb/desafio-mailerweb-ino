...
class RoomModel(Base):
    ...
    bookings: Mapped[list["BookingModel"]] = relationship("BookingModel", back_populates="room")
...
class BookingModel(Base):
    ...
    status: Mapped[BookingStatusEnum] = mapped_column(Enum(BookingStatusEnum), nullable=False, default=BookingStatusEnum.ACTIVE)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())
    updated_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now(), onupdate=func.now())
    ...
    participants: Mapped[list["BookingParticipantModel"]] = relationship("BookingParticipantModel", back_populates="booking", cascade="all, delete-orphan")
    outbox_events: Mapped[list["OutboxEventModel"]] = relationship("OutboxEventModel", back_populates="booking")
...
class BookingParticipantModel(Base):
    ...
    booking: Mapped["BookingModel"] = relationship("BookingModel", back_populates="participants")
...
class OutboxEventModel(Base):
    ...
    status: Mapped[OutboxStatusEnum] = mapped_column(Enum(OutboxStatusEnum), nullable=False, default=OutboxStatusEnum.PENDING)
    ...
    booking: Mapped["BookingModel"] = relationship("BookingModel", back_populates="outbox_events")
